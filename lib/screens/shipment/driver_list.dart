...
class _DriverShipmentListState extends State<DriverShipmentList> {
  ...
  Future<void> handleDelivery(User driver, Shipment t) async {
    ...
    await uploadTask;
    final tb = t.toBuilder();
    tb.status = ShipmentStatus.delivered;
    widget.shipmentBloc.add(UpdateShipment(t.id!, tb.build()));
  }
    ...
    void showAlertDialog(BuildContext context, Shipment t) {
      ...
      final Widget continueButton = TextButton(
        ...
        onPressed: () {
          ...
          tb.status = ShipmentStatus.rejected;
          tb.driverId = null;
          widget.shipmentBloc.add(UpdateShipment(t.id!, tb.build()));
          Navigator.of(context).pop();
        },
                      ...
                      children: [
                        TextButton(
                          ...
                          onPressed: () {
                            ...
                            tb.status = ShipmentStatus.accepted;
                            widget.shipmentBloc
                                .add(UpdateShipment(t.id!, tb.build()));
                          },
                          child: Text(
